...
<head>
  ...
  <title>quiero amarte siempre, n :)</title>
  <style>
    @font-face {
      font-family: 'KaroooFont';
      src: url('FuenteDeKarooo-Regular.otf') format('opentype');
    }
    ...
    body {
      margin: 0;
      padding: 0;
      font-family: 'KaroooFont', sans-serif;
...
por fin te tengo.
    ...
    <div class="imagenes">
      <img src="uno.jpeg" alt="Imagen 1">
      <img src="due.jpeg" alt="Imagen 2">
      <img src="tre.jpeg" alt="Imagen 3">
      <img src="cuatro.jpeg" alt="Imagen 4">
    </div>
 <p>
  ...
  <script>
    ...
    function mostrarRecuerdo() {
      const seccion = document.getElementById("recuerdo");
